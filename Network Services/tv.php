...
<form action="intv.php" method="post">
   ...
   <center> <h2>OFFERS</h2></center>
    ...
    <table class="data">
        ...
        <tfoot>
			...
			<?php
		$query="SELECT * FROM tv_plans ORDER BY t_id asc";
        ...
        <tbody>
            ...
            <tr>
                <td><input type="radio" name="nam" value="<?php echo $row["t_id"];?>"><?php echo $row["t_amount"];?></td>
				<td><input type="radio" name="namee" value="<?php echo $row["t_amount"];?>"></td>
           ...
           <?php
			...
			<center><input type="submit" class="button" name="subb" value="submit"></center>
</article>
</form>
</form>
